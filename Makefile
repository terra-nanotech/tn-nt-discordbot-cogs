# Makefile for TN-NT Discordbot Cogs
...
# Variables
appname = tnnt-discordbot-cogs
appname_verbose = TN-NT Discordbot Cogs
...
git_repository = https://github.com/ppfeufer/tn-nt-discordbot-cogs
